...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ExitusRO digitalizează fluxul administrativ după deces în România: de la CMCD la certificatul de deces și înmormântare." },
      { name: "author", content: "ExitusRO" },
      { property: "og:title", content: "ExitusRO — Platformă digitală pentru proceduri post-deces" },
      { property: "og:description", content: "ExitusRO digitalizează fluxul administrativ după deces în România: de la CMCD la certificatul de deces și înmormântare." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "ExitusRO — Platformă digitală pentru proceduri post-deces" },
      { name: "twitter:description", content: "ExitusRO digitalizează fluxul administrativ după deces în România: de la CMCD la certificatul de deces și înmormântare." },
